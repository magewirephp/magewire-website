...
class ExampleTest extends TestCase
{
    ...
    public function test_theme_compatibility_uses_visual_status_cards(): void
    {
        $this->get('/')
            ->assertOk()
            ->assertSee('Platforms &amp; runtime', false)
            ->assertSee('Mage-OS')
            ->assertSee('1.3.1 to 3.2.0')
            ->assertSee('Magento Open Source')
            ->assertSee('2.4.6-p15 to 2.4.9')
            ->assertSee('Adobe Commerce')
            ->assertSee('Magento Commerce')
            ...
            ->assertSee('/images/compatibility/php.webp', false)
            ->assertSee('Compatibility matrix')
            ->assertSee('Supported Magewire V3 combinations')
            ->assertSee('2.4.6-p15')
            ->assertSee('2.4.7-p10')
            ->assertSee('2.4.8-p5')
            ->assertSee('1.3.1')
